...
Usage:
    python benchmark/training/compress_and_save.py \
        --method fwsvd \
        --rank 300 \
        --backend flashsvd \
...
def parse_args():
    ...
    parser.add_argument("--output_dir", default="compressed_models")
...
def main():
    ...
    print(f"Will compress the {args.method} model and save to: {output_path}")
    print(f"This will run the benchmark script for compression...")
    print()

    # Build command
    cmd = [
        sys.executable,
        "src/encoders/compress.py",
        "--method", args.method,
    ...
    print("=" * 60)
    print("Running compression and saving...")
    print("=" * 60)

...
Usage:
    python benchmark/training/finetune_from_checkpoint.py \
        --checkpoint compressed_models/bert/fwsvd/fwsvd_r300_flashsvd \
        --learning_rate 2e-5 \
        --num_epochs 3 \
        --batch_size 32
"""
...
def parse_args():
    ...
    parser.add_argument("--output_dir", default="experiments/finetuned_models")

...
if is_flash_attn_2_available():
    try:
        ...
        # flash-attn is an optional dependency and can be present but ABI-incompatible
        # with the installed PyTorch (common: undefined symbol errors). Don't fail
        # import of the whole repo in that case.
        warnings.warn(
            f"[FlashSVDTrain] flash_attn is installed but failed to import; falling back to non-flash attention. "

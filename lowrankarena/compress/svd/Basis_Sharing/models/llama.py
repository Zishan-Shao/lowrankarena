...
try:
    from transformers.models.llama.modeling_llama import LlamaSdpaAttention  # type: ignore
except ImportError:  # transformers>=4.57 renamed this path back to LlamaAttention
...
class ShareLlamaSdpaAttention(LlamaSdpaAttention):
    def __init__(self, config, layer_idx, k_basis, q_basis, v_basis, o_basis):
        ...
        # transformers>=4.57 no longer keeps these legacy aliases on LlamaAttention

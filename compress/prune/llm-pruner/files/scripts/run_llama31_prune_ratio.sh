...
#SBATCH --mem=80G
#SBATCH -t 3-00:00:00
#SBATCH -o /deac/csc/yangGrp/cuij/LLM/llm-pruner/logs/slurm_llama31_prune_%j.out
#SBATCH -e /deac/csc/yangGrp/cuij/LLM/llm-pruner/logs/slurm_llama31_prune_%j.err
...
save_tag="l31_8b_r${ratio}_prune"
python llama3.py \
  --pruning_ratio ${ratio} \

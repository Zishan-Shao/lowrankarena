...
#SBATCH --mem=80G
#SBATCH -t 2-00:00:00
#SBATCH -o /deac/csc/yangGrp/cuij/LLM/llm-pruner/logs/slurm_l2_eval_%j.out
#SBATCH -e /deac/csc/yangGrp/cuij/LLM/llm-pruner/logs/slurm_l2_eval_%j.err
...
ckpt="/deac/csc/yangGrp/cuij/LLM/llm-pruner/prune_log/l2_7b_r${ratio}_prune/pytorch_model.bin"
...
python scripts/run_lm_eval_with_llama2_checkpoint.py \
  ...
  --device cuda:0 \
  --output_path results/llama2_7b_r${ratio}_pruned_7task.json \
  --no_cache

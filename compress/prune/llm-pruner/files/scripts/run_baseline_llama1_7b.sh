#!/bin/bash
#SBATCH -J llmpruner_l1_7b_baseline
#SBATCH -p gpu
#SBATCH --gres=gpu:1
...
#SBATCH --mem=80G
#SBATCH -t 2-00:00:00
#SBATCH -o /deac/csc/yangGrp/cuij/LLM/llm-pruner/logs/slurm_llama1_7b_baseline_%j.out
#SBATCH -e /deac/csc/yangGrp/cuij/LLM/llm-pruner/logs/slurm_llama1_7b_baseline_%j.err

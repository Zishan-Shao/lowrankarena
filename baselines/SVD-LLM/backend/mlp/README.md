# FlashSVD MLP Backends

This folder holds backend-facing MLP decode implementations.
It exists so backend-specific exact/experimental paths do not masquerade as top-level kernels.

## What is active

- Active exact dual-split Triton backend code lives in:
...
Use [`../../benchmark/mlp/compare_exact_backends.py`](../../benchmark/mlp/compare_exact_backends.py) to compare:
...
/home/zs89/FlashSVD/FlashSVD-v1.5/benchmark/mlp/compare_exact_backends.py \
...
CUDA_VISIBLE_DEVICES=5 \
/home/zs89/miniconda3/envs/flashsvd/bin/python \
/home/zs89/FlashSVD/FlashSVD-v1.5/benchmark/mlp/compare_decode_backends.py \
--checkpoint /home/zs89/FlashSVD/FlashSVD-v1.5/jeffwan_llama_7b_hf_whitening_only_0.5.pt \
--dtype bf16 \
--device cuda \
--prompt_len 512 \
...
- Exact dual-split backend code now lives under this folder.
- Generic SwiGLU and shared-split experiments now live in:
  - [`../../benchmark/mlp/legacy_swiglu/generic.py`](../../benchmark/mlp/legacy_swiglu/generic.py)
  - [`../../benchmark/mlp/legacy_swiglu/shared_split.py`](../../benchmark/mlp/legacy_swiglu/shared_split.py)

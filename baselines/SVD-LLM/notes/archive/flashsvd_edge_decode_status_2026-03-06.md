...
/home/zs89/miniconda3/envs/flashsvd/bin/python \
  /home/zs89/FlashSVD/FlashSVD-v1.5/benchmark/attn/decode_compare.py \
  --llama llama2-7b \
...
- basis packing and prepacked reconstruct helper:
  - [`flashsvdropeattn_dense_decode.py`](../kernels/flashsvdropeattn_dense_decode.py)
- benchmark integration:
  - [`decode_compare.py`](../benchmark/attn/decode_compare.py)
...
```bash
/home/zs89/miniconda3/envs/flashsvd/bin/python \
  /home/zs89/FlashSVD/FlashSVD-v1.5/benchmark/mlp/bench_svd_llama_decode_graph.py \
  --batches 1 4 \
  --seq-len 1 \
  --warmup 20 \
  --runs 80
...
- Added:
  - [`bench_decode_stack_compare.py`](../benchmark/legacy/archive/flashsvdropeattn_short/bench_decode_stack_compare.py)
- Purpose:
...
```bash
/home/zs89/miniconda3/envs/flashsvd/bin/python \
  /home/zs89/FlashSVD/FlashSVD-v1.5/benchmark/legacy/archive/flashsvdropeattn_short/bench_decode_stack_compare.py \
  --llama llama2-7b \
  --ratio 0.5 \
  --B 1 \
...
- MLP:
  - the current legacy SwiGLU path under `benchmark/mlp/legacy_swiglu` is not competitive in this stack benchmark.
...
- [`benchmark/mlp/legacy_swiglu/__init__.py`](../benchmark/mlp/legacy_swiglu/__init__.py)
...
- top-level now keeps only the active files:
  - `benchmark/attn/decode_compare.py`
...
- older exploratory scripts were moved to:
  - [`flashsvdropeattn_short/legacy/`](../benchmark/legacy/archive/flashsvdropeattn_short/legacy)

...
- `benchmark/decode/bench_flashsvd_vs_svd_decode.py` now defaults to `--mlp_cuda_graph_scope mlp`
...
- compare FlashSVD vs normal SVD on the same checkpoint:
  - `benchmark/decode/bench_flashsvd_vs_svd_decode.py`
- v2 wrapper:
...
/home/zs89/miniconda3/envs/flashsvd/bin/python \
  /home/zs89/FlashSVD/FlashSVD-v1.5/benchmark/decode/bench_flashsvd_vs_svd_decode.py \

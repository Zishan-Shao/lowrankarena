...
Run from repo root with:
  CUDA_VISIBLE_DEVICES=0 python benchmark/legacy/archive/flashsvdffn/compare.py --help
"""
...
def main() -> int:
    ...
    v15_path = str(archive_root / "v1.5" / "flashsvdffn" / "flashsvdffn_v1.5.py")
    v1_path = str(archive_root / "v1" / "flashsvdffn" / "flashsvdffn_v1.py")

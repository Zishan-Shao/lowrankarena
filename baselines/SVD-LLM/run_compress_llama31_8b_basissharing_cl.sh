#!/bin/bash
# Cross-layer Basis Sharing — Llama-3.1-8B
...
OUTPUT_DIR="/home/ww247/lowrankarena/hf_ckpts/LowRankArena/llama31_8b/BasisSharingCL"
LOG_DIR="$BS_DIR/logs"
...
for RATIO in 20 30 40 50 60; do
    ...
    CFG="$CFG_DIR/share_llama31_8b_${RATIO}_server.yaml"
    CKPT_DIR="$OUTPUT_DIR/llama31_8b_cl_bs_${KEEP}"
    LOG="$LOG_DIR/llama31_8b_cl_bs_${KEEP}.log"

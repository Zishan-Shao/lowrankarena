#!/bin/bash
# ABLinear Basis Sharing compression for Qwen/Qwen3-8B
...
MODEL="Qwen/Qwen3-8B"
MODEL_TAG="Qwen3-8B"
OUTPUT_DIR="/home/ww247/lowrankarena/hf_ckpts/LowRankArena/qwen3_8b/BasisSharingAB"
LOG_DIR="$LRA_DIR/logs"

mkdir -p "$LOG_DIR" "$OUTPUT_DIR"

for KEEP in 0.8 0.7 0.6 0.5 0.4; do
    CKPT_DIR="$OUTPUT_DIR/qwen3_8b_bs_ab_${KEEP}"

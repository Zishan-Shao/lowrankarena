...
def _configure_mode(
    ...
    *,
    ...
    if mode == "flashsvd":
        ...
        _set_env("FLASH_SVD_ENABLE_DENSE_ATTN_DECODE", True)
...
def _bench_one_mode(
    *,
    ...
    lowrank_cache, flashsvd_dense_cache = _configure_mode(
        mode,
...
def main() -> int:
    ap = argparse.ArgumentParser("Compare decode speed: FlashSVD winner path vs normal SVD baseline")
    ...
    ap.add_argument("--flashsvd_ffn_backend", type=str, default="auto", choices=["auto", "dual_split_cublas", "dual_split_cublas_legacy", "dual_split_kernel"])
    ...
    print(
        ...
        f"scope={args.mlp_cuda_graph_scope}"
    )

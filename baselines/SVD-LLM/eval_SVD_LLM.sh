...
# eval benchmarks with lm eval 
cd /home/lz299/lowrankarena

export PYTHONPATH="$PWD/baselines/SVD-LLM:$PWD:$PYTHONPATH"

CUDA_VISIBLE_DEVICES=1 \
python eval_results/eval_benchmarks.py \
...
CUDA_VISIBLE_DEVICES=1 \
python eval_results/eval_general_ppl.py \

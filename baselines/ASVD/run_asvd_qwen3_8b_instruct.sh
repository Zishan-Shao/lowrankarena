...
#
# Usage:
#   bash run_asvd_qwen3_8b_instruct.sh
#
# Checkpoints: checkpoints/asvd/qwen3_8b_instruct/Qwen3_8B_Instruct_asvd_raw_*.pt
...
SAVE_DIR="checkpoints/asvd/qwen3_8b_instruct"

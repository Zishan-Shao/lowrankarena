...
def main() -> None:
    ...
    for set_name, set_tasks in task_sets:
        ...
        _perf_set = PerfRecorder(args.device, label=f"lm_eval_set:{set_name}")
        _perf_set.__enter__()
        ...
        _perf_set.__exit__(None, None, None)
        perf["task_sets"][set_name] = _perf_set.to_dict()

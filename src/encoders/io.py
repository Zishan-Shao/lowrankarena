...
def load_compressed_model(
    ...
    try:
        ...
        # Some models (e.g. ModernBERT) only have a fast tokenizer; use_fast=False is ignored
        # and falls back to the fast tokenizer which may fail on older tokenizers versions.

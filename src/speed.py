...
def run_speed(request: SpeedRequest, index_path: str | None = None) -> SpeedResult:
    ...
    result = run_speed_suite(
        VllmSpeedRequest(
            ...
            host=request.extra.get("host"),
            port=request.extra.get("port"),
            request_rate=request.extra.get("request_rate"),
            num_prompts=request.extra.get("num_prompts"),
            max_concurrency=request.extra.get("max_concurrency"),
            ready_check_timeout_seconds=request.extra.get("ready_check_timeout_seconds"),

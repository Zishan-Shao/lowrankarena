#!/bin/bash
# Evaluate SVD-LLM Basis Sharing compressed checkpoints for Qwen3-8B.
# Loads from safetensors directories (model.safetensors + svd_metadata.json).
#
# Usage:
#   bash run_eval_qwen3_8b_basissharing.sh
#
# Output: results/qwen3_8b.csv
...
OUTPUT_DIR="/home/ww247/lowrankarena/hf_ckpts/LowRankArena/qwen3_8b/BasisSharing"
MODEL_PREFIX="Qwen_Qwen3_8B"
METHOD="Basis_sharing"
CSV="results/qwen3_8b.csv"
DTYPE="bf16"
DEVICE="cuda:0"
BATCH="2"
